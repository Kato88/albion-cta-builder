...
namespace Zorn.Repos
{
    public class UserRepo : IUserRepo
    {
        ...
        public UserRepo(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IOptions<JWT> jwt)
        {
        ...
        public async Task<string> RegisterAsync(RegisterModel model)
        {
            ...
            var userWithSameEmail = await _userManager.FindByEmailAsync(model.UserName);
